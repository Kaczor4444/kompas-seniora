...
export default function DodajMopsPage() {
  ...
  const onSubmit = async (data: MopsFormData) => {
    ...
    try {
      ...
      router.push('/admin/mops?success=added');
    } catch (err) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Dodaj MOPS/GOPS</h1>
          <p className="text-sm text-gray-500 mt-0.5">Nowy wpis ośrodka pomocy społecznej</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex items-center justify-between pb-8">
          ...
          <button type="submit" disabled={isSubmitting}
            ...
            {isSubmitting ? 'Zapisywanie...' : 'Dodaj MOPS/GOPS'}
          </button>
        </div>
      </form>
    </div>
