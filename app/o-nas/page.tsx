...
export const metadata: Metadata = {
  title: 'O nas - Kompas Seniora | Pomoc w wyborze opieki nad seniorem',
  description: 'Dowiedz się, dlaczego powstał Kompas Seniora. Pomagamy rodzinom znaleźć najlepszą opiekę dla seniorów - DPS, ŚDS, wsparcie dzienne. Oficjalne dane, prosty język.',
  keywords: 'o nas, kompas seniora, opieka nad seniorem, DPS, dom opieki, pomoc seniorom',
};
