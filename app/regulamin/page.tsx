            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="bg-slate-900 p-8 md:p-14 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-6">Regulamin Serwisu</h1>
              ...
              <div className="p-8 md:p-14">
                ...
                <section id="sec-1" className="mb-12 scroll-mt-32">
                  ...
                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-100 mb-6">
                    <p className="text-[10px] font-black uppercase tracking-widest text-emerald-700 mb-4">Właściciel i administrator Serwisu:</p>
                ...
                <section id="sec-5" className="mb-12 scroll-mt-32">
                  ...
                  <div className="bg-amber-50 p-6 rounded-xl border border-amber-100 flex gap-4 mb-6">
                ...
                <section id="sec-7" className="mb-12 scroll-mt-32">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    ...
                    {' '}<a href="/polityka-prywatnosci" className="text-emerald-700 underline underline-offset-4 font-bold">
                ...
                <div className="bg-slate-900 text-white p-8 rounded-2xl text-center mt-12">
                  <p className="font-black tracking-tighter text-xl mb-4">"Jasne zasady, przejrzysta komunikacja."</p>
