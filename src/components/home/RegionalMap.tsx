  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 md:gap-12 lg:gap-28">
          ...
          {/* MAP CONTAINER */}
          <div className="flex-1 order-2 lg:order-2 flex justify-center items-start relative w-full px-4 md:px-0 -mt-24 md:-mt-32 lg:-mt-48">
            <div className="relative w-full max-w-[650px] aspect-[3.5/5] p-2 md:p-8 group/map">
              ...
              >
                <defs>
                   ...
                   {/* Inactive region solid fill - no gradient */}
