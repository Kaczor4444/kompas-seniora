...
export default function HomeClient({ totalFacilities, totalWolne, wolneMonth, powiatCounts, featuredArticles, typeCounts, typeCountsSlaskie, powiatCountsByType, powiatCountsByTypeSlaskie }: HomeClientProps) {
