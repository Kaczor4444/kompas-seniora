...
export default function PoradnikiContent({ initialArticles }: PoradnikiContentProps) {
            ...
            <div className="bg-white rounded-xl border-2 border-gray-200 p-5">
              ...
              <div className="space-y-3">
                {popularArticles.map((article, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-7 h-7 bg-emerald-600 text-white rounded-full flex items-center justify-center font-bold text-xs">
                      {index + 1}
                    </div>
